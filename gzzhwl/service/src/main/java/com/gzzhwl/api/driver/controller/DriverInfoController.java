...
public class DriverInfoController {
	...
	@RequestMapping(value = "/getCBSDriver", method = RequestMethod.GET)
	public ResponseModel getCBSDriver(@Authorization AccountInfo accountInfo) {
		String accountId = accountInfo.getAccountId();
		DriverInfoVo vo = service.getCBSDriverInfo(accountId);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/queryDriverandVehicleDetail", method = RequestMethod.POST, consumes = {MediaType.APPLICATION_JSON_VALUE })
	public ResponseModel queryDriverandVehicleDetail(@RequestBody DriverAndVehicleVo driverAndVehicleVo,@Authorization AccountInfo accountInfo) {
		driverAndVehicleVo.setAccountId(accountInfo.getAccountId());
		Map<String, Object> result = vehicleManageService.getDriverandVehicleDetail(driverAndVehicleVo);
		return new ResponseModel(result);
	}
	 ...
	 * 
	 */
	@RequestMapping(value = "/pageUsableDriverAndVehicleList", method = RequestMethod.GET)
	public ResponseModel pageUsableDriverAndVehicleList(@Authorization AccountInfo accountInfo, @Pagination PageParameter page) {
		String accountId = accountInfo.getAccountId();
		Page<Map<String, Object>> data = service.pageUsableDriverAndVehicleList(accountId, page.getPageIndex(), page.getPageSize());
		return new ResponseModel(data);
	}
	...
	public ResponseModel getDriverInfo(@Authorization AccountInfo accountInfo, @RequestParam String driverInfoId) {
		DriverInfoVo data = service.getDriverInfo(driverInfoId);
		return new ResponseModel(data);
	}
}
