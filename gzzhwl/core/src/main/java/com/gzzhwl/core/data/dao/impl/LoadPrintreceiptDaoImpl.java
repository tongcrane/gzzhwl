 ...
 */
@Repository
public class LoadPrintreceiptDaoImpl implements LoadPrintreceiptDao {
	@Autowired	
	...
	public int insert(LoadPrintreceipt loadPrintreceipt) {
		return dao.insert(PREFIX + ".insert", loadPrintreceipt);
	}

	@Override
	public int update(LoadPrintreceipt loadPrintreceipt) {
		return dao.update(PREFIX + ".update", loadPrintreceipt);
	}
	
	@Override
	public int updateSelective(LoadPrintreceipt loadPrintreceipt) {
		return dao.update(PREFIX + ".updateSelective", loadPrintreceipt);
	}
