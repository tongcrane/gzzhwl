 ...
 */
@Repository
public class DriverContractInfoDaoImpl implements DriverContractInfoDao {
	@Autowired
	...
	public int insert(DriverContractInfo driverContractInfo) {
		return dao.insert(PREFIX + ".insert", driverContractInfo);
	}

	@Override
	public int update(DriverContractInfo driverContractInfo) {
		return dao.update(PREFIX + ".update", driverContractInfo);
	}

	@Override
	public int updateSelective(DriverContractInfo driverContractInfo) {
		return dao.update(PREFIX + ".updateSelective", driverContractInfo);
	}
	...
	public String getContractByLoad(Map<String, Object> params) {
		return dao.get(PREFIX + ".getContractByLoad", params);
	}
}
