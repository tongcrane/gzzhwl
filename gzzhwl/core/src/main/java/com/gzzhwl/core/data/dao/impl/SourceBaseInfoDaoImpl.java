 ...
 */
@Repository
public class SourceBaseInfoDaoImpl implements SourceBaseInfoDao {
	@Autowired
	...
	public SourceBaseInfo getByOrderId(String orderId) {
		...
		return dao.get(PREFIX + ".getByOrderId", params);
	}
	...
	public int insert(SourceBaseInfo sourceBaseInfo) {
		return dao.insert(PREFIX + ".insert", sourceBaseInfo);
	}

	@Override
	public int update(SourceBaseInfo sourceBaseInfo) {
		return dao.update(PREFIX + ".update", sourceBaseInfo);
	}

	@Override
	public int updateSelective(SourceBaseInfo sourceBaseInfo) {
		return dao.update(PREFIX + ".updateSelective", sourceBaseInfo);
	}
