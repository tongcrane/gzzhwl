 ...
 */
package com.gzzhwl.patchca.filter.predefined;

import java.awt.image.BufferedImageOp;
import java.util.ArrayList;
import java.util.List;

import com.gzzhwl.patchca.filter.AbstractFilterFactory;
import com.gzzhwl.patchca.filter.library.DoubleRippleImageOp;
