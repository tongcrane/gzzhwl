			...
			for(var j=0;j< markers.length;j++){
				...
				if(j>1){
					...
					if(markers[j].exception == "01"){
				        ...
				        info.push("<p><span style=\"width: 105px; display:inline-block;\">行驶速度</span>"+curSped+"</p></div>");
					}else{
				        //构建信息窗体中显示的内容
				        ...
				        info.push("<p><span style=\"width: 75px; display:inline-block;\">行驶速度</span>"+curSped+"</p></div>");
					}
				}else{
					//设置起点终点的信息
					var address = "";
