...
<div class="handle">
	<div class="handle-btn">
		...
		<a href="javascript:void(0);" class="del-car">删除</a>
	</div>
	...
	<table>
		<thead>
			<tr>
				...
				<th>车牌号</th>
				<th width="115">车长（米）</th>
				<th width="120">载重（kg）</th>
				<th width="106" >车主</th>
				<th width="152" >联系电话</th>
				<th width="110" class="bus_sel_single short">
					类型
					<ul class="statu_s" >
					</ul>
				</th>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/information/carInfoList.js?v=${sessionId}"></script>