...
//          .append('<li class="ui-multiselect-close"><a href="#" class="ui-multiselect-close"><span class="ui-icon '+o.closeIcon+'"></span></a></li>')
    ...
    refresh : function(init) {
      ...
      function makeItem(option, isInOptionGroup) {
        ...
        var labelClasses = [ 'ui-multiselect-option' ];
        var liClasses = [];
        ...
        $.map(extension, function(value, key) {
...
//          $(this).removeClass('ui-state-focus');
      ...
      .delegate('input[type="checkbox"], input[type="radio"]', 'click.multiselect', function(e) {
		...
		var result = $.extend({}, $this.data(), { value: val, text: this.title, checked: checked });
        // bail if this input is disabled or the event is cancelled
        if(this.disabled || self._trigger('click', e, result) === false) {
          e.preventDefault();
          return;
        }
    ...
    setValue : function(value){
    	...
    	var _this = this;
    	$.each(_values, function(i, j){
    		var _current = j;
    		_this.menu.find('input').each(function(k, l){
        		if(_current == l.value){
        			l.click();
        			return false;
        		}
    ...
    selectValue : function(value){
        ...
        $inputs.each(this._toggleState('checked', false));
        
        $.each(value, function(i, j){
        	var _current = j;
        	$inputs.each(function(i, j){
        		if(_current == j.value){
        			self._toggleState('checked', true).call(this);
        			return false;
        		}
            });
        });
...
//        $inputs.each(this._toggleState('checked', true));
...
//		console.log("位置"+pos.top);
//		console.log("窗口高度"+windowHeight);
//		console.log("滚动条高度"+windowScrollTop);
//		console.log("下拉框高度"+this.menu.outerHeight());
//		console.log(pos.top+this.button.outerHeight()+this.menu.outerHeight());
//		console.log(windowHeight+windowScrollTop);
		var _selectHeight=pos.top+this.button.outerHeight()+this.menu.outerHeight();
		var _scrollHeight=windowHeight+windowScrollTop;
		var _topPosition;
		if(_selectHeight<_scrollHeight) {
			_topPosition=pos.top + this.button.outerHeight();
		} else {
			_topPosition=pos.top-this.menu.outerHeight();
		}
        this.menu.css({
          top: _topPosition,
          left: pos.left
